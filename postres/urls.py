...
from .views import home, contacto, acercade, menu, chocolateria, postres, tortas, administracion, usuarios, form_prod, form_mod_prod, form_del_prod,form_reg_usuario,form_reg_mod_usuario, form_reg_del_usuario,registro,admin_categoria
